...
- Реализовано:
    ...
    - Правило валидации значений, являющихся представлениями дат и времени (DateRule)
    - Правило валидации проверяющее существование значения в таблице базы данных (ExistRule)
    - Юнит тесты правил валидации
- Изменено:
